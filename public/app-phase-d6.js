...
async function boot() {
  try {
    ...
    document.getElementById("status").textContent="✅ Phase D.6 loaded. Simplified Hunter system restored; all data remains fake/local and the live Monster Hunt save is untouched.";
  } catch (err) {
    console.error(err);
